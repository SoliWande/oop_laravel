...
class Dinosaur{
    ...
    public function action($objData, $data){
        ...
        if($objData->att->lay == 0){
            ...
            app('BuildWorld')->writeInfoLog("dinosaur {$oldCoordinates} starved ");
            return $dataReturn;
        }
        ...
        if($checkEat){
            ...
            $objData->att->lay = app('Animal')->getLay(config('animal.dinosaur.id'));
            // update lại tọa độ
            ...
            app('BuildWorld')->writeInfoLog("dinosaur {$oldCoordinates} eat {$nameBeHunted} in coordinates {$coordinatesHunted} ");
            return $dataReturn;
        }
        ...
        if($createStep==0){
            ...
            if($checkBorn){
                ...
                $objData->att->create = app('Animal')->getLay(config('animal.dinosaur.id'));
                // tọa độ đứng im
                ...
                app('BuildWorld')->writeInfoLog("dinosaur {$oldCoordinates} born Egg in coordinates {$coordinatesBorn} ");
                return $dataReturn;
            }
        }
        ...
        if(!empty($checkMove)){
            ...
            app('BuildWorld')->writeInfoLog("dinosaur {$oldCoordinates} move to coordinates {$checkMove['value']} ");
            return $dataReturn;
        }
        ...
        app('BuildWorld')->writeInfoLog("dinosaur {$oldCoordinates} stayed ");
        return $dataReturn;
